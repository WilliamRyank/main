...
.  Should be able to hold up to 1000 people without a noticeable sluggishness in performance for typical usage.
...
. Deleting a person while all people are listed

.. Prerequisites: List all people using the `list` command. Multiple people in the list.
.. Test case: `delete 1` +
